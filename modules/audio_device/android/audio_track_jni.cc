...
bool AudioTrackJni::JavaAudioTrack::InitPlayout(int sample_rate, int channels) {
  double buffer_size_factor =
      strtod(web_rtc::field_trial::FindFullName(
  ...
  JNINativeMethod native_methods[] = {
      {"nativeCacheDirectBufferAddress", "(Ljava/nio/ByteBuffer;J)V",
       reinterpret_cast<void*>(
           &web_rtc::AudioTrackJni::CacheDirectBufferAddress)},
      {"nativeGetPlayoutData", "(IJ)V",
       reinterpret_cast<void*>(&web_rtc::AudioTrackJni::GetPlayoutData)}};
...
void JNICALL AudioTrackJni::CacheDirectBufferAddress(JNIEnv* env,
  ...
  web_rtc::AudioTrackJni* this_object =
      reinterpret_cast<web_rtc::AudioTrackJni*>(nativeAudioTrack);
