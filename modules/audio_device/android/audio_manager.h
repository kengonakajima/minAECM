...
class AudioManager {
 public:
  ...
  // Possible values are web_rtc::kLowLatencyModeDelayEstimateInMilliseconds and
  // web_rtc::kHighLatencyModeDelayEstimateInMilliseconds.
 ...
 private:
  ...
  web_rtc::ScopedSLObjectItf engine_object_;
