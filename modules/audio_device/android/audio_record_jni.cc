  ...
  JNINativeMethod native_methods[] = {
      {"nativeCacheDirectBufferAddress", "(Ljava/nio/ByteBuffer;J)V",
       reinterpret_cast<void*>(
           &web_rtc::AudioRecordJni::CacheDirectBufferAddress)},
      {"nativeDataIsRecorded", "(IJ)V",
       reinterpret_cast<void*>(&web_rtc::AudioRecordJni::DataIsRecorded)}};
...
void JNICALL AudioRecordJni::CacheDirectBufferAddress(JNIEnv* env,
  ...
  web_rtc::AudioRecordJni* this_object =
      reinterpret_cast<web_rtc::AudioRecordJni*>(nativeAudioRecord);
