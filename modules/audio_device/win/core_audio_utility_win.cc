...
using web_rtc::AudioDeviceName;
using web_rtc::AudioParameters;

namespace web_rtc {
namespace web_rtc_win {
namespace {
...
bool GetDeviceNamesInternal(EDataFlow data_flow,
                            web_rtc::AudioDeviceNames* device_names) {
...
bool GetInputDeviceNames(web_rtc::AudioDeviceNames* device_names) {
...
bool GetOutputDeviceNames(web_rtc::AudioDeviceNames* device_names) {
...
HRESULT GetPreferredAudioParameters(IAudioClient* client,
                                    web_rtc::AudioParameters* params,
...
web_rtc::TimeDelta ReferenceTimeToTimeDelta(REFERENCE_TIME time) {
  // Each unit of reference time is 100 nanoseconds <=> 0.1 microsecond.
  return web_rtc::TimeDelta::Micros(0.1 * time + 0.5);
}
