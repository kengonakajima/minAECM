...
class RTC_EXPORT VCMEncodedFrame : public EncodedImage {
 public:
   ...
   */
  const web_rtc::EncodedImage& EncodedImage() const {
    return static_cast<const web_rtc::EncodedImage&>(*this);
  }
   ...
   *   Get frame type
   */
  web_rtc::VideoFrameType FrameType() const { return _frameType; }
  /**
   *   Set frame type
   */
  void SetFrameType(web_rtc::VideoFrameType frame_type) {
