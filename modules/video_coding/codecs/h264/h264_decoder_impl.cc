...
int32_t H264DecoderImpl::Decode(const EncodedImage& input_image,
  ...
  const web_rtc::PlanarYuvBuffer* planar_yuv_buffer = nullptr;
  const web_rtc::PlanarYuv8Buffer* planar_yuv8_buffer = nullptr;
  const web_rtc::PlanarYuv16BBuffer* planar_yuv16_buffer = nullptr;
  ...
  switch (video_frame_buffer_type) {
    case VideoFrameBuffer::Type::kI420:
      ...
      planar_yuv8_buffer =
          reinterpret_cast<const web_rtc::PlanarYuv8Buffer*>(planar_yuv_buffer);
      break;
    ...
    case VideoFrameBuffer::Type::kI010:
      ...
      planar_yuv16_buffer = reinterpret_cast<const web_rtc::PlanarYuv16BBuffer*>(
          planar_yuv_buffer);
      break;
  ...
  rtc::scoped_refptr<web_rtc::VideoFrameBuffer> cropped_buffer;
  switch (video_frame_buffer_type) {
    case VideoFrameBuffer::Type::kI420:
