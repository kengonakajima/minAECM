...
static constexpr web_rtc::TimeDelta kEncodeTimeout =
    web_rtc::TimeDelta::Millis(100);
static constexpr web_rtc::TimeDelta kDecodeTimeout =
    web_rtc::TimeDelta::Millis(25);
...
void VideoCodecUnitTest::SetUp() {
  web_rtc::test::CodecSettings(kVideoCodecVP8, &codec_settings_);
