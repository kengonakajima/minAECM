...
size_t GetMaxNaluSizeBytes(const EncodedImage& encoded_frame,
  ...
  std::vector<web_rtc::H264::NaluIndex> nalu_indices =
...
VideoProcessor::VideoProcessor(web_rtc::VideoEncoder* encoder,
...
void VideoProcessor::ProcessFrame() {
  ...
  VideoFrame input_frame =
      VideoFrame::Builder()
          ...
          .set_rotation(web_rtc::kVideoRotation_0)
          .build();
...
void VideoProcessor::FrameEncoded(
  ...
  const web_rtc::EncodedImage* encoded_image_for_decode = &encoded_image;
...
const web_rtc::EncodedImage* VideoProcessor::BuildAndStoreSuperframe(
