...
VideoStatistics VideoCodecTestStatsImpl::SliceAndCalcVideoStatistic(
  ...
  web_rtc_impl::RunningStatistics<float> buffer_level_sec;

  web_rtc_impl::RunningStatistics<size_t> key_frame_size_bytes;
  web_rtc_impl::RunningStatistics<size_t> delta_frame_size_bytes;

  web_rtc_impl::RunningStatistics<size_t> frame_encoding_time_us;
  web_rtc_impl::RunningStatistics<size_t> frame_decoding_time_us;

  web_rtc_impl::RunningStatistics<float> psnr_y;
  web_rtc_impl::RunningStatistics<float> psnr_u;
  web_rtc_impl::RunningStatistics<float> psnr_v;
  web_rtc_impl::RunningStatistics<float> psnr;
  web_rtc_impl::RunningStatistics<float> ssim;
  web_rtc_impl::RunningStatistics<int> qp;
  ...
  auto MaxDelaySec = [target_bitrate_kbps](
                         const web_rtc_impl::RunningStatistics<size_t>& stats) {
