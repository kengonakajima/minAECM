...
class TestMultiplexAdapter : public VideoCodecUnitTest,
 ...
 public:
  TestMultiplexAdapter()
      : decoder_factory_(new web_rtc::MockVideoDecoderFactory),
        encoder_factory_(new web_rtc::MockVideoEncoderFactory),
 ...
 protected:
  ...
  void ModifyCodecSettings(VideoCodec* codec_settings) override {
    web_rtc::test::CodecSettings(kMultiplexAssociatedCodecType, codec_settings);
    codec_settings->VP9()->numberOfTemporalLayers = 1;
    codec_settings->VP9()->numberOfSpatialLayers = 1;
    codec_settings->codecType = web_rtc::kVideoCodecMultiplex;
  }
  ...
  std::unique_ptr<VideoFrame> CreateI420AInputFrame() {
    ...
    rtc::scoped_refptr<web_rtc::I420BufferInterface> yuv_buffer =
 ...
 private:
  ...
  const std::unique_ptr<web_rtc::MockVideoDecoderFactory> decoder_factory_;
  const std::unique_ptr<web_rtc::MockVideoEncoderFactory> encoder_factory_;
