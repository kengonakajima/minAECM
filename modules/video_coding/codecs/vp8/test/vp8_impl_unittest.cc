...
using EncoderInfo = web_rtc::VideoEncoder::EncoderInfo;
using FramerateFractions =
    absl::InlinedVector<uint8_t, web_rtc::kMaxTemporalStreams>;
...
class TestVp8Impl : public VideoCodecUnitTest {
 protected:
  ...
  void ModifyCodecSettings(VideoCodec* codec_settings) override {
    web_rtc::test::CodecSettings(kVideoCodecVP8, codec_settings);
