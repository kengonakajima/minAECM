...
namespace {
void CopyFromConfigToEvent(const web_rtc::InternalAPMConfig& config,
                           web_rtc::audioproc::Config* pb_cfg) {
...
std::unique_ptr<AecDump> AecDumpFactory::Create(web_rtc::FileWrapper file,
                                                int64_t max_log_size_bytes,
                                                rtc::TaskQueue* worker_queue) {
