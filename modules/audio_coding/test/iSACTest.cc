...
void ISACTest::Setup() {
  ...
  std::string fileNameA = web_rtc::test::OutputPath() + "testisac_a.pcm";
  std::string fileNameB = web_rtc::test::OutputPath() + "testisac_b.pcm";
...
void ISACTest::EncodeDecode(int testNr,
  ...
  file_stream_a << web_rtc::test::OutputPath();
  file_stream_b << web_rtc::test::OutputPath();
