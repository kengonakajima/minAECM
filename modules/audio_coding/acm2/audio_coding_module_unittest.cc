 ...
 protected:
  ...
  void SetUp() override {
    ...
    const std::string input_file_name =
        web_rtc::test::ResourcePath("audio_coding/speech_mono_16kHz", "pcm");
...
class AcmSenderBitExactnessOldApi : public ::testing::Test,
 ...
 protected:
  ...
  const std::string kTestFileFakeStereo32kHz =
      web_rtc::test::ResourcePath("audio_coding/testfile_fake_stereo_32kHz",
                                 "pcm");
  const std::string kTestFileQuad48kHz = web_rtc::test::ResourcePath(
