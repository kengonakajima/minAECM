...
namespace {
class MockEncodedAudioFrame : public web_rtc::AudioDecoder::EncodedAudioFrame {
 public:
...
class PacketGenerator {
 public:
  ...
  web_rtc::Packet NextPacket(
      int payload_size_bytes,
      std::unique_ptr<web_rtc::AudioDecoder::EncodedAudioFrame> audio_frame);
...
web_rtc::Packet PacketGenerator::NextPacket(
    int payload_size_bytes,
    std::unique_ptr<web_rtc::AudioDecoder::EncodedAudioFrame> audio_frame) {
  web_rtc::Packet packet;
