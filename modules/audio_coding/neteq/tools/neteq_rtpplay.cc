...
using TestConfig = web_rtc::test::NetEqTestFactory::Config;
...
int main(int argc, char* argv[]) {
  ...
  web_rtc::test::NetEqTestFactory factory;
  std::string usage =
  ...
  web_rtc::field_trial::InitFieldTrialsFromString(force_fieldtrials.c_str());

  web_rtc::test::NetEqTestFactory::Config config;
  ...
  std::unique_ptr<web_rtc::test::NetEqTest> test =
