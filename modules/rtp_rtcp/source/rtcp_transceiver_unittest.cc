...
using ::web_rtc::MockTransport;
using ::web_rtc::RtcpTransceiver;
using ::web_rtc::RtcpTransceiverConfig;
using ::web_rtc::SimulatedClock;
using ::web_rtc::TaskQueueForTest;
using ::web_rtc::Timestamp;
using ::web_rtc::rtcp::RemoteEstimate;
using ::web_rtc::rtcp::RtcpPacket;
using ::web_rtc::rtcp::TransportFeedback;
using ::web_rtc::test::RtcpPacketParser;

class MockMediaReceiverRtcpObserver : public web_rtc::MediaReceiverRtcpObserver {
 public:
  MOCK_METHOD(void,
              OnSenderReport,
              (uint32_t, web_rtc::NtpTime, uint32_t),
              (override));
};

constexpr web_rtc::TimeDelta kTimeout = web_rtc::TimeDelta::Seconds(1);
