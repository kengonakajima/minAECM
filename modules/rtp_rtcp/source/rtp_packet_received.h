...
class RtpPacketReceived : public RtpPacket {
 public:
  ...
  explicit RtpPacketReceived(
      ...
      web_rtc::Timestamp arrival_time = web_rtc::Timestamp::MinusInfinity());
  ...
  // network.
  web_rtc::Timestamp arrival_time() const { return arrival_time_; }
  void set_arrival_time(web_rtc::Timestamp time) { arrival_time_ = time; }
 ...
 private:
  web_rtc::Timestamp arrival_time_ = Timestamp::MinusInfinity();
