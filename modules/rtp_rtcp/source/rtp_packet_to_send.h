...
class RtpPacketToSend : public RtpPacket {
 public:
  ...
  web_rtc::Timestamp capture_time() const { return capture_time_; }
  void set_capture_time(web_rtc::Timestamp time) { capture_time_ = time; }
 ...
 private:
  web_rtc::Timestamp capture_time_ = web_rtc::Timestamp::Zero();
