...
using ::web_rtc::rtcp::Bye;
using ::web_rtc::rtcp::CompoundPacket;
using ::web_rtc::rtcp::ReportBlock;
using ::web_rtc::rtcp::SenderReport;
using ::web_rtc::test::RtcpPacketParser;
...
class FakeRtcpTransport : public web_rtc::Transport {
 public:
  ...
  bool SendRtp(const uint8_t*, size_t, const web_rtc::PacketOptions&) override {
...
class RtcpParserTransport : public web_rtc::Transport {
 public:
...
TEST_F(RtcpTransceiverImplTest, AvoidsEmptyPacketsInReducedMode) {
  ...
  RtcpTransceiverConfig config = DefaultTestConfig();
  config.outgoing_transport = &transport;
  config.rtcp_mode = web_rtc::RtcpMode::kReducedSize;
...
TEST_F(RtcpTransceiverImplTest, CallsObserverOnTargetBitrateBySenderSsrc) {
  ...
  web_rtc::rtcp::TargetBitrate target_bitrate;
  ...
  web_rtc::rtcp::ExtendedReports xr;
...
TEST_F(RtcpTransceiverImplTest, SkipsIncorrectTargetBitrateEntries) {
  ...
  web_rtc::rtcp::TargetBitrate target_bitrate;
  target_bitrate.AddTargetBitrate(0, 0, /*target_bitrate_kbps=*/10);
  target_bitrate.AddTargetBitrate(0, web_rtc::kMaxTemporalStreams, 20);
  target_bitrate.AddTargetBitrate(web_rtc::kMaxSpatialLayers, 0, 40);
...
TEST_F(RtcpTransceiverImplTest, CallsObserverOnByeBehindUnknownRtcpPacket) {
  ...
  auto app = std::make_unique<web_rtc::rtcp::App>();
...
TEST_F(RtcpTransceiverImplTest, KeyFrameRequestCreatesCompoundPacket) {
  ...
  config.rtcp_mode = web_rtc::RtcpMode::kCompound;
...
TEST_F(RtcpTransceiverImplTest, IgnoresUnknownSsrcInDlrr) {
  ...
  web_rtc::rtcp::ReceiveTimeInfo rti;
