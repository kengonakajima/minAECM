...
RTC_NORETURN void rtc_FatalMessage(const char* file,
                                   ...
                                   const char* msg) {
#if RTC_CHECK_MSG_ENABLED
  static constexpr rtc::web_rtc_checks_impl::CheckArgType t[] = {
      rtc::web_rtc_checks_impl::CheckArgType::kEnd};
  rtc::web_rtc_checks_impl::FatalLog(file, line, msg, t);
#else
  rtc::web_rtc_checks_impl::FatalLog(file, line);
#endif
}
