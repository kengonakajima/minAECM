...
class RTC_EXPORT PhysicalSocketServer : public SocketServer {
 public:
  ...
  // SocketServer:
  bool Wait(web_rtc::TimeDelta max_wait_duration, bool process_io) override;
 ...
 private:
  ...
  static int ToCmsWait(web_rtc::TimeDelta max_wait_duration);
#if defined(WEBRTC_POSIX)
