...
namespace web_rtc_network_internal {
...
class MdnsResponderProvider {
 public:
  ...
  virtual web_rtc::MdnsResponderInterface* GetMdnsResponder() const = 0;
};
...
class RTC_EXPORT NetworkManager : public DefaultLocalAddressProvider,
 ...
 public:
  ...
  web_rtc::MdnsResponderInterface* GetMdnsResponder() const override;
...
class RTC_EXPORT NetworkManagerBase : public NetworkManager {
 public:
  NetworkManagerBase(const web_rtc::FieldTrialsView* field_trials = nullptr);
 ...
 private:
  ...
  const web_rtc::FieldTrialsView* field_trials_ = nullptr;
...
class RTC_EXPORT BasicNetworkManager : public NetworkManagerBase,
 ...
 public:
  ...
  BasicNetworkManager(SocketFactory* socket_factory,
                      const web_rtc::FieldTrialsView* field_trials = nullptr)
 ...
 private:
  ...
  web_rtc::AlwaysValidPointer<const web_rtc::FieldTrialsView,
                             web_rtc::FieldTrialBasedConfig>
      field_trials_;
  ...
  rtc::scoped_refptr<web_rtc::PendingTaskSafetyFlag> task_safety_flag_;
};
...
class RTC_EXPORT Network {
 public:
  ...
  web_rtc::MdnsResponderInterface* GetMdnsResponder() const;
  ...
  uint16_t GetCost(const web_rtc::FieldTrialsView* field_trials = nullptr) const;
  uint16_t GetCost(const web_rtc::FieldTrialsView& field_trials) const;
