...
class FakeTaskQueue : public web_rtc::TaskQueueBase {
 public:
  ...
  void PostDelayedTask(absl::AnyInvocable<void() &&> task,
                       web_rtc::TimeDelta delay) override {}
...
TEST(UniqueNumberGenerator, UsedOnSecondaryThread) {
  const auto* current_tq = web_rtc::TaskQueueBase::Current();
  ...
  ASSERT_NE(current_tq, web_rtc::TaskQueueBase::Current());
