...
class EventLogger final {
 public:
  ...
  void Log() {
    ...
    static constexpr web_rtc::TimeDelta kLoggingInterval =
        web_rtc::TimeDelta::Millis(100);
 ...
 private:
  ...
  web_rtc::SequenceChecker thread_checker_;
...
void SetupInternalTracer(bool enable_all_categories) {
  ...
  web_rtc::SetupEventTracer(enable_all_categories ? InternalEnableAllCategories
...
void ShutdownInternalTracer() {
  ...
  delete old_logger;
  web_rtc::SetupEventTracer(nullptr, nullptr);
}
