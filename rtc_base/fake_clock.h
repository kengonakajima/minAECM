...
// Starts at time 0.
//
// TODO(deadbeef): Unify with web_rtc::SimulatedClock.
class FakeClock : public ClockInterface {
 public:
  ...
  void SetTime(web_rtc::Timestamp new_time);

  void AdvanceTime(web_rtc::TimeDelta delta);

 private:
  mutable web_rtc::Mutex lock_;
...
class ThreadProcessingFakeClock : public ClockInterface {
 public:
  ...
  void SetTime(web_rtc::Timestamp time);
  void AdvanceTime(web_rtc::TimeDelta delta);
