...
class flat_map : public ::web_rtc::flat_containers_internal::flat_tree<
                     Key,
                     flat_containers_internal::GetFirst,
                     Compare,
                     Container> {
 private:
  using tree = typename ::web_rtc::flat_containers_internal::
...
using ::web_rtc::flat_containers_internal::EraseIf;
