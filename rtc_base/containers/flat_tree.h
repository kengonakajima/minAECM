...
class flat_tree {
 public:
  ...
  // the input be sorted.
  //
  // When passing the web_rtc::sorted_unique tag as the first argument no sort
  ...
  //
  // Prefer web_rtc::EraseIf() or some other variation on erase(remove(), end())
...
template <class Key,
          ...
          typename Predicate>
size_t EraseIf(
    web_rtc::flat_containers_internal::
