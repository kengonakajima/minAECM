...
struct RTC_EXPORT PacketOptions {
  ...
  // When used with RTP packets (for example, web_rtc::PacketOptions), the value
...
class RTC_EXPORT AsyncPacketSocket : public sigslot::has_slots<> {
 ...
 protected:
  ...
  RTC_NO_UNIQUE_ADDRESS web_rtc::SequenceChecker network_checker_;

 private:
  web_rtc::CallbackList<AsyncPacketSocket*, int> on_close_
